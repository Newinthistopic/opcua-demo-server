...
function PIDSHUTDOWN(i, nameNodeId, serverValues) {
  ...
  function calculateNextValue() {
    ...
    if (Math.abs(rSet - rAct2) > 0.1) {
     ...
     // Prüfen, ob u_begrenzt kleiner als 0 ist und entsprechend Null oder den berechneten Wert zuweisen
          serverValues[werte.data[i].SU3111_ZeExtruder_Hmi_udtEmPz_rPzCv_rAct.nodeId.value] = 0
