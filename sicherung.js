...
module.exports = {
    ...
    run: function (addressSpace, device, opcua, verbose, serverValues,) {
        ...
        for (let i = 0; i < 14; i++) {
            ...
            //   var rTempCooldownSet = createCustomVariable("rTempCooldownSet", rTempCooldown, "ZEEX_3111_Parameter", "udtEmPz", "rTempCooldown"," ", serverValues);
            // var rTempCooldownMax = createCustomVariable("rTempCooldownMax", rTempCooldown, "ZEEX_3111_Parameter", "udtEmPz", "rTempCooldown", "Max", serverValues);
            ...
            function createCustomVariable(variableName, componentOf, browseName, part1, part2, part3, part4, customGetLogic) {
                ...
                newVariable[variableName] = namespace3.addVariable({
                    ...
                    value: {
                        get: function () {
                            var nameNodeId = this.nodeId.value;
                        ...
                        set: function (variant) {
                            const nameNodeId = this.nodeId.value;
                            serverValues[nameNodeId] = parseFloat(variant.value);
                            return opcua.StatusCodes.Good;
                        }
                    }
                });
            ...
            var rTempReleaseMin = namespace3.addVariable({
                componentOf: rTempRelease,
                browseName: "Min",
                dataType: opcua.DataType.Float,
                nodeId: "ns=3;s=" + "\"ZEEX_3111_Parameter\".\"udtEmPz\"" + "[" + i + "]" + ".\"rTempRel\".\"Min\"",
                value: {
                    get: function () {
                        const rTempReleaseMinNodeId = this.nodeId.value;
                        //initial.initialstartrTempCooldownNodeId(i, rSetTolHHMin, serverValues);
                        return new opcua.Variant({ dataType: opcua.DataType.Float, value: serverValues[rTempReleaseMinNodeId] });
                    },
                    set: function (variant) {
                        return opcua.StatusCodes.Good;
                    }
