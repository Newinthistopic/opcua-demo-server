...
.     *
    ...
    bindExtensionObjectArray(optionalExtensionObject, options) {
        (0, node_opcua_assert_1.assert)(this.valueRank === 1, "expecting a Array variable here");
        return (0, ua_variable_impl_ext_obj_1._bindExtensionObjectArray)(this, optionalExtensionObject, options);
    }
    bindExtensionObject(optionalExtensionObject, options) {
        ...
        if (this.valueRank === -1) {
            ...
            return (0, ua_variable_impl_ext_obj_1._bindExtensionObjectMatrix)(this, undefined, options);
        }
        //  unsupported case ... 
        return null;
    }
