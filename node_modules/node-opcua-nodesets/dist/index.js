...
exports.constructNodesetFilename = void 0;
const fs = require("fs");
const path = require("path");

function constructNodesetFilename(filename) {
    let file = path.join(process.cwd(), "node_modules/node-opcua-nodesets/nodesets", filename);
    if (!fs.existsSync(file)) {
        if (!process.argv[1]) {
            throw new Error(`cannot find file ${file}\nPlease make sure that nodeset can be found in ${path.join(process.cwd(), "nodesets")}`);
        }
...
path.join(__dirname, "node_modules/node-opcua-nodesets/nodesets/Opc.Ua.NodeSet2.xml");
path.join(__dirname, "node_modules/node-opcua-nodesets/nodesets/Opc.Ua.Di.NodeSet2.xml");
path.join(__dirname, "node_modules/node-opcua-nodesets/nodesets/Opc.Ua.Adi.NodeSet2.xml");
path.join(__dirname, "node_modules/node-opcua-nodesets/nodesets/Opc.Ua.AutoID.NodeSet2.xml");
path.join(__dirname, "node_modules/node-opcua-nodesets/nodesets/Opc.Ua.MachineVision.NodeSet2.xml");
path.join(__dirname, "node_modules/node-opcua-nodesets/nodesets/Opc.Ua.Robotics.NodeSet2.xml");
path.join(__dirname, "node_modules/node-opcua-nodesets/nodeset/Opc.Ua.Ijt.Tightening.NodeSet2.xml");
// ------------------------------------------------------------- }}
